...
Describe 'Invoke-GroupsConsoleGetRecipientDetails' {
    ...
    It 'keeps primary email and normalizes the external target for mail users' {
        ...
        $result.recipient.externalEmailAddress | Should -Be 'jane.personal@example.com'
        $result.recipient.externalEmailAddress | Should -Not -Be 'SMTP:jane.personal@example.com'
